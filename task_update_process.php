    ...
    if ($stmt->execute()) {
        ...
        switch ($_SESSION['role']) {
            case 'admin':
                ...
                header("Location: admin/admin_update_subtask_after_edit_main_task.php?task_id=" . $main_task_id);

                // header("Location: admin/admin_task_modify.php");
                break;
            case 'manager':
                // header("Location: manager/manager_task_modify.php");
                header("Location: manager/manager_update_subtask_after_edit_main_task.php?task_id=" . $main_task_id);
                break;
            case 'department':
                // header("Location: user/user_task_modify.php");
                header("Location: user/user_update_subtask_after_edit_main_task.php?task_id=" . $main_task_id);
                break;
            default:
                session_destroy();
                header("Location: login.php");
