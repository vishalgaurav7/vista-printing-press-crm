        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPagestask">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="manager_dashboard.php" class="side-nav-link">
                                <span class="menu-text">Create Task</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="manager_task_modify.php" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="manager_task_status_modify.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPages">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="manager_update_subtask.php" class="side-nav-link">
                                <span class="menu-text">Update Sub-Task</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="manager_completed_subtask.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
            <a href="manager_department_manage.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
            <a href="manager_master.php" class="side-nav-link">
          ...
          <li class="side-nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="side-nav-item">
                                    ...
                                    <div class="collapse" id="sidebarSecondLevel">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_tasks.php" class="side-nav-link">
                                                    <span class="menu-text">All Running Task</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_completed_tasks.php" class="side-nav-link">
                                                    <span class="menu-text">Completed Task Date Wise</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_near_delivery_tasks.php" class="side-nav-link">
                                                    <span class="menu-text">Near Delivery Task</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_late_tasks.php" class="side-nav-link">
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <div class="collapse" id="sidebarThirdLevel">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_subtasks.php" class="side-nav-link">
                                                    <span class="menu-text">All Running Sub-Task</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_completed_subtasks.php" class="side-nav-link">
                                                    <span class="menu-text">Completed Sub-Task</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_near_date_subtasks.php" class="side-nav-link">
                                                    <span class="menu-text">Near Delivery Sub-Task</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="manager_report_view_overdue_subtasks.php" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
            <a href="manager_change_password.php" class="side-nav-link">
